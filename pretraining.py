...
import torch
torch.hub.set_dir("EfficientAD/models")
...
# variables
model_size = 'small'
imagenet_train_path = 'data/screw/train'
seed = 42
...
def main():
    ...
    config = get_argparse()
    config.output_folder = r"EfficientAD/output/1"

    os.makedirs(config.output_folder, exist_ok=True)

    backbone = models.wide_resnet101_2(weights=None)
    backbone.load_state_dict(torch.load("EfficientAd/models/wide_resnet101_2-32ee1156.pth"))
